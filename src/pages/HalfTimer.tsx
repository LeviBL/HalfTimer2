    ...
    <div className="min-h-screen flex flex-col items-center bg-gray-50 text-gray-800 relative">
      ...
      <div className="w-full flex flex-col items-center p-4 pt-16 relative">
        ...
        <div className="w-full max-w-[1100px] relative">
          ...
          {/* Desktop Sponsorship Sidebar - Static position, closer to cards, farther from browser edge */}
          <div className="hidden min-[1180px]:block absolute right-[-340px] top-0 h-full">
        ...
        <div className="min-[1180px]:hidden mt-12 w-full flex justify-center">
          <SponsorshipPlaceholder />
        </div>
      </div>
