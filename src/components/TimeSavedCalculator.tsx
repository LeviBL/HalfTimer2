  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button 
          className="w-10 h-10 rounded-full bg-white/80 backdrop-blur-sm shadow-md flex items-center justify-center hover:bg-white transition-all border border-gray-200"
          aria-label="Time Saved Calculator"
        >
          <Calculator className="h-5 w-5 text-slate-900" />
        </button>
      </PopoverTrigger>
      <PopoverContent className="w-80 p-6 bg-white text-slate-900 border border-gray-100 rounded-3xl shadow-2xl">
        <div className="space-y-6">
          <div className="space-y-2">
            <h4 className="font-black uppercase tracking-tighter text-gray-500 text-xs">Time Saved Calculator</h4>
