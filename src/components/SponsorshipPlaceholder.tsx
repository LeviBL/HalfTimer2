...
export default function SponsorshipPlaceholder() {
  ...
  return (
    <a 
      ...
      className="group block w-full max-w-[280px] sm:max-w-sm mx-auto border-2 border-dashed border-[#cfcfcf] bg-neutral-50/50 hover:bg-neutral-50 hover:border-[#9281c7] p-6 rounded-2xl transition-all duration-200 ease-in-out text-center shadow-sm"
    >
